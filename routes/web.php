...
// ==================== DİL DEĞİŞTİRME ROUTE'U ====================

Route::get('lang/{locale}', function ($locale) {
    if (in_array($locale, ['en', 'tk', 'ru'])) { 
        Session::put('locale', $locale);
    }
    return redirect()->back();
})->name('lang.switch');

// ==================== MEVCUT ROUTE'LAR (DEĞİŞMEDEN KALIYOR) ====================
Route::get('/', function () {
    return view('home', [
        'title' => 'Online Taxi| Book A Taxi Ride With Us Today!']);
});

Route::get('/about', function () {
    return view('about', [
        'title' => 'About | Online Taxi']);
});
...
Route::get('/admin', function () {
    return view('admin.index', [
        'title' => 'Dashboard Admin | Online taxi',
    ]);
})->middleware('auth');
